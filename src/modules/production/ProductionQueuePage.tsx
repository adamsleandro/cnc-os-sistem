...
export function ProductionQueuePage() {
  ...
  const handleOpenEdit = (os: typeof newOS & { id: string }) => {
    setEditingId(os.id);
    setNewOS({
      number: os.number,
      title: os.title,
      ...
      material_type: os.material_type || "Aço Carbono",
      thickness_mm: os.thickness_mm || 1.5,
      cutting_perimeter_mm: os.cutting_perimeter_mm || 5000,
      total_pierces: os.total_pierces || 20,
      sheet_yield_percent: os.sheet_yield_percent || 85,
      quality: os.quality || "producao",
      estimated_minutes: os.estimated_minutes || 30,
    });
    setIsModalOpen(true);
  };
              ...
              {orders.length === 0 ? (
                ...
                orders.map((os) => (
                  <OSCard
                    key={os.id}
                    order={os}
                    onClick={() => handleOpenEdit(os as any)}
                  />
                ))
              )}
            </div>
          ...
          <div className="bg-white w-full max-w-xl rounded-[32px] overflow-hidden shadow-2xl relative z-10 animate-in fade-in zoom-in duration-200">
            <div className="p-8 border-b border-slate-100 flex items-center justify-between">
              <h2 className="text-2xl font-black text-slate-900 tracking-tight">
                {editingId ? "EDITAR OS" : "CRIAR NOVA OS"}
              </h2>
              <button
                onClick={() => {
                  setIsModalOpen(false);
            ...
            <form onSubmit={handleSaveOS} className="p-8 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-1 space-y-2">
                  ...
                  <input
                    ...
                    value={newOS.number}
                    onChange={(e) =>
                      setNewOS({ ...newOS, number: e.target.value })
                    }
                    placeholder="ex: 1045"
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  value={newOS.title}
                  onChange={(e) =>
                    setNewOS({ ...newOS, title: e.target.value })
                  }
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setNewOS({ ...newOS, client_name: e.target.value })
                  }
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-1 space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewOS({ ...newOS, material_type: e.target.value })
                    }
                ...
                <div className="col-span-1 space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewOS({
                        ...newOS,
                        cutting_perimeter_mm: Number(e.target.value),
                      })
                    }
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
                  />
                ...
                <div className="col-span-1 space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewOS({
                        ...newOS,
                        total_pierces: Number(e.target.value),
                      })
                    }
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
                  />
                  ...
                  <div className="col-span-2">
                    <p className="text-[9px] font-bold text-slate-400 italic">
                      * Tempo estimado automático:{" "}
                      {CuttingEngineService.estimateTime(
                        newOS.cutting_perimeter_mm || 0,
                        newOS.total_pierces || 0,
                        1000,
                        newOS.quality as any,
                      )}{" "}
                      min
                    </p>
                  </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-1 space-y-2">
                  ...
                  <select
                    value={newOS.quality}
                    onChange={(e) =>
                      setNewOS({ ...newOS, quality: e.target.value as any })
                    }
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
                  >
                ...
                <div className="col-span-1 space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setNewOS({
                        ...newOS,
                        sheet_yield_percent: Number(e.target.value),
                      })
                    }
                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
                  />
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    setNewOS({ ...newOS, machine_id: e.target.value })
                  }
                  className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 font-bold outline-none focus:ring-2 focus:ring-blue-500/20"
                >
              ...
              >
                {editingId ? "Salvar Alterações" : "Confirmar e Lançar OS"}
              </button>
            </form>
          </div>
        </div>
